...
model_dir = r'/hdd/data+/Paul/Models/DeeplabV3_snVienna2_PS(286, 286)_BS5_EP90_LR5e-05_DS50_DR0.1_SFN32'
...
blCol = uab_collectionFunctions.uabCollection('testing_set_100')
blCol.readMetadata()
...
file_list_valid = uabCrossValMaker.make_file_list_by_key(
    idx, file_list, [i for i in range(0, 5000)],  filter_list=[])
file_list_valid_truth = uabCrossValMaker.make_file_list_by_key(
    idx_truth, file_list_truth, [i for i in range(0, 5000)], filter_list=[])
